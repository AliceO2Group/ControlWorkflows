...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/cpv-physics-qcmn-epn.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/cpv-physics-qcmn-epn'
...
add_qc_remote_machine_attribute workflows/${WF_NAME}.yaml alio2-cr1-qme07
