...
# Variables
WF_NAME=ft0-digits-qc-ds-pipe-raw
export DPL_CONDITION_BACKEND="http://127.0.0.1:8084"
DPL_PROCESSING_CONFIG_KEY_VALUES="NameConf.mCCDBServer=http://127.0.0.1:8084;"
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/ft0-digits-qc-ds.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/ft0-digits-qc-ds-{{ it }}'
...
o2-dpl-raw-proxy -b --session default \
  ...
  | o2-ft0-flp-dpl-workflow -b --session default --disable-root-output --pipeline  ft0-datareader-dpl:$N_PIPELINES\
