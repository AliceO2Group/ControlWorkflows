...
# Variables
WF_NAME=fv0-digits-qc-postproc-ds-pipe
export DPL_CONDITION_BACKEND="http://127.0.0.1:8084"
DPL_PROCESSING_CONFIG_KEY_VALUES="NameConf.mCCDBServer=http://127.0.0.1:8084;"
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/fv0-digits-qc-postproc-ds.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/fv0-digits-qc-postproc-ds-{{ it }}'
...
o2-dpl-raw-proxy -b --session default \
  ...
  | o2-fv0-flp-dpl-workflow -b --session default --disable-root-output --pipeline  fv0-datareader-dpl:$N_PIPELINES \
