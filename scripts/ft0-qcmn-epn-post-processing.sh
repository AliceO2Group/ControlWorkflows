...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/ft0-qcmn-epn-post-processing.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/ft0-qcmn-epn-post-processing'
...
WF_NAME=ft0-qcmn-epn-post-processing-remote
