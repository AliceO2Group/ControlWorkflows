...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/tpc-full-calib-trend-qcmn.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/tpc-full-calib-trend-qcmn'
...
WF_NAME=tpc-full-calib-trend-remote
