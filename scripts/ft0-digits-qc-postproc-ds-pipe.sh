...
# Variables
WF_NAME=ft0-digits-qc-postproc-ds-pipe
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/ft0-digits-qc-postproc-ds.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/ft0-digits-qc-postproc-ds-{{ it }}'
