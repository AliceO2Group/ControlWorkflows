...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/tpc-full-nodummy-postprocessing-qcmn-v2.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/tpc-full-nodummy-postprocessing-qcmn-v2'
...
WF_NAME=tpc-full-nodummy-qcmn-pp-remote-v2
