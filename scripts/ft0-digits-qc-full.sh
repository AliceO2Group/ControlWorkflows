...
o2-dpl-raw-proxy -b --session default \
  ...
  | o2-calibration-ccdb-populator-workflow -b --session default --ccdb-path=http://ccdb-test.cern.ch:8080 --configKeyValues "${DPL_PROCESSING_CONFIG_KEY_VALUES}" \
