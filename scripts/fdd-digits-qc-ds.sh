...
# Variables
WF_NAME=fdd-digits-qc-ds
export DPL_CONDITION_BACKEND="http://127.0.0.1:8084"
DPL_PROCESSING_CONFIG_KEY_VALUES="NameConf.mCCDBServer=http://127.0.0.1:8084;"
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/fdd-digits-qc-ds.json'
...
o2-dpl-raw-proxy -b --session default \
  ...
  | o2-fdd-flp-dpl-workflow -b --session default --disable-root-output --configKeyValues "${DPL_PROCESSING_CONFIG_KEY_VALUES}" \
