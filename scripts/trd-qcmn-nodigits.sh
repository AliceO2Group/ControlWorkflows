...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/trd-full-qcmn-nodigits-epn.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/trd-full-qcmn-nodigits'
